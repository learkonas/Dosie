...
tweetpush.addTweet = async function ({tweet, tag1, tag2, source, url, type, length, tweet_date, author_pfp, top_line, tweet_link, images_in_tweet, poll_options, poll_close_date}) {
   try {
...
tweetpush.addThread = async function (finalArray, coreStats) {
   try {
      const response = await notion.pages.create({
         "parent": {
         "type": "database_id",
